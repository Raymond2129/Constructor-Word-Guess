...
var wordBank = [
    "rod", "reel", "pole", "bass", "trout", "perch", "liplesscrank", "squarebill", "stick bait", "jerkbait", "worms", "grubs", "poontoon", "basstracker", "icefishing", "spoons", "castmaster", "bassmaster"
];
...
function init() {
  pickedWords = [];
  console.log("Welcome to the Word fishing game!");
  console.log("------------------------------------------");
  playGame();
}
...
function playGame() {
  ...
  if(pickedWords.length < wordBank.length) {
    ...
    // WIN CONDITION
    console.log("You know a lot about fishing! You are awesome!");
    continuePrompt();
  }
  if(pickedWord) {
